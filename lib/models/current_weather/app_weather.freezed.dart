...
class _$AppWeatherImpl with DiagnosticableTreeMixin implements _AppWeather {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AppWeather(name: $name, country: $country, temp: $temp, tempMin: $tempMin, tempMax: $tempMax, description: $description, icon: $icon)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, country, temp, tempMin, tempMax, description, icon);
...
abstract class _AppWeather implements AppWeather {
  const factory _AppWeather(
      ...
      required final String icon}) = _$AppWeatherImpl;
