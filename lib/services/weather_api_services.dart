...
import 'package:weather_app/services/dio_error_handler.dart';
...
class WeatherApiServices {
  ...
  Future<DirectGeocoding> getDirectGeocoding(String city) async {
    try {
      ...
      if (response.data.isEmpty) {
        //This error is possible if it can not get location
  ...
  Future<String> getReverseGeocoding (double lat, double lon) async{
    try {
      ...
      if(result.isEmpty){
        throw WeatherException('Cannot get the name of the location($lat, $lon)');
      }
